package com.shoppingapp.primeshop.dao
...
interface TaskDao {
    ...
    @Query("UPDATE Task SET taskTitle=:title, description = :description, price = :price, category = :category, imageUrl = :imageUrl WHERE taskId = :taskId")
    suspend fun updateTaskPaticularField(taskId:String,title:String,description:String,price:String,category:String,imageUrl:String): Int
